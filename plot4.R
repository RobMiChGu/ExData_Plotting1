...
globalReactivePower <- as.numeric(datenbereich$Global_reactive_power)
voltage <- as.numeric(datenbereich$Voltage)
...
png("E:/Data Science Foundations using R/4 Explorative Datenanalyse/Woche 1/plot4.png", width=480, height=480)
par(mfrow = c(2, 2)) 
